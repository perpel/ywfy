...
<table width="100%" border="0" class="tablelist" cellspacing="0">
  ...
  <tr>
    ...
    <td><?= $form->field($model, 'FirstDraftDate', ['template'=>'{label}'])?></td>
    <td><?= $form->field($model, 'FirstDraftDate', ['template'=>'{input}{error}'])->textInput(["class"=>"Wdate", "onfocus"=>"WdatePicker()"])?></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><?= $form->field($model, 'Cycle', ['template'=>'{input}{error}'])?></td>
  </tr>
