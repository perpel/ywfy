...
<?php
    ...
    foreach(  Document::find()->asArray()->all() as $k=>$v ){
            ...
            if($v["Project"]){
                echo "<td data-key='Project' data-btn='Project'><input type='checkbox' checked value=1></td>";
            }else{
                echo "<td data-key='Project' data-btn='Project'><input type='checkbox' value=0></td>";
            }
